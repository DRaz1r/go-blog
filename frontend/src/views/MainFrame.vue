<template>
    <div>
        ...
        <div style="position: fixed; top: 0; height: 50px; width: 100%; z-index: 998; ">
            <div class="card">
...
const loadArticles = async(pageNum = 0) =>{
    ...
    // categoryId筛选
    let res = await axios.post(`/article/list?keyword=${pageInfo.keyword}&pageNum=${pageInfo.pageNum}&pageSize=${pageInfo.pageSize}`)
...
const searchByCategory = () => {
    ...
    pageInfo.categoryId = selectedCategory.value
    pageInfo.pageNum = 1
    loadArticles()
}
